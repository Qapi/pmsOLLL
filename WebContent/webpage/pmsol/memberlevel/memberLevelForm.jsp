...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="memberLevel" action="${ctx}/memberlevel/memberLevel/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<form:input path="salePercent" htmlEscape="false"    class="form-control "/>
					</td>
					<td class="width-15 active"><label class="pull-right">有效期：</label></td>
					<td class="width-35">
						<input id="validityTerm" name="validityTerm" type="text" maxlength="20" class="laydate-icon form-control layer-date "
							value="<fmt:formatDate value="${memberLevel.validityTerm}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
					</td>
				</tr>
				<tr>
