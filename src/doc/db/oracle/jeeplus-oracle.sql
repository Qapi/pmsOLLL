...
prompt Created on 2016年10月6日 by Administrator
set feedback off
set define off
...
comment on column CATEGORY.NAME
  is '类型名';
comment on column CATEGORY.CREATE_BY
  is '创建者';
comment on column CATEGORY.CREATE_DATE
  is '创建时间';
comment on column CATEGORY.UPDATE_BY
  is '更新者';
comment on column CATEGORY.UPDATE_DATE
  is '更新时间';
comment on column CATEGORY.REMARKS
  is '备注信息';
comment on column CATEGORY.DEL_FLAG
  is '逻辑删除标记（0：显示；1：隐藏）';
...
comment on column GOODS.ID
  is '主键';
comment on column GOODS.CREATE_BY
  is '创建者';
comment on column GOODS.CREATE_DATE
  is '创建时间';
comment on column GOODS.UPDATE_BY
  is '更新者';
comment on column GOODS.UPDATE_DATE
  is '更新时间';
comment on column GOODS.REMARKS
  is '备注信息';
comment on column GOODS.DEL_FLAG
  is '逻辑删除标记（0：显示；1：隐藏）';
comment on column GOODS.NAME
  is '商品名称';
comment on column GOODS.CATEGORY_ID
  is '所属类型';
...
comment on table TESTNOTE
  is '富文本测试';
comment on column TESTNOTE.ID
  is '主键';
comment on column TESTNOTE.CREATE_BY
  is '创建者';
comment on column TESTNOTE.CREATE_DATE
  is '创建时间';
comment on column TESTNOTE.UPDATE_BY
  is '更新者';
comment on column TESTNOTE.UPDATE_DATE
  is '更新时间';
comment on column TESTNOTE.REMARKS
  is '备注信息';
comment on column TESTNOTE.DEL_FLAG
  is '逻辑删除标记（0：显示；1：隐藏）';
comment on column TESTNOTE.TITLE
  is '标题';
alter table TESTNOTE
  add constraint PK_TESTNOTE_ID primary key (ID)
  using index 
  tablespace SYSTEM
  pctfree 10
  initrans 2
...
prompt Creating TEST_LINE_WEATHER_MAIN_CITY...
...
(
  ...
  DEL_FLAG          VARCHAR2(64),
  DATESTR           DATE,
  BEIJING_MAXTEMP   FLOAT(24),
  BEIJING_MINTEMP   FLOAT(24),
  CHANGCHUN_MAXTEMP FLOAT(24),
  CHANGCHUN_MINTEMP FLOAT(24),
  SHENYANG_MAXTEMP  FLOAT(24),
  SHENYANG_MINTEMP  FLOAT(24),
  HAERBIN_MAXTEMP   FLOAT(24),
  HAERBIN_MINTEMP   FLOAT(24)
)
tablespace USERS
  pctfree 10
  initrans 1
...
comment on table TEST_LINE_WEATHER_MAIN_CITY
  is '城市气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.ID
  is '主键';
comment on column TEST_LINE_WEATHER_MAIN_CITY.CREATE_BY
  is '创建者';
comment on column TEST_LINE_WEATHER_MAIN_CITY.CREATE_DATE
  is '创建时间';
comment on column TEST_LINE_WEATHER_MAIN_CITY.UPDATE_BY
  is '更新者';
comment on column TEST_LINE_WEATHER_MAIN_CITY.UPDATE_DATE
  is '更新时间';
comment on column TEST_LINE_WEATHER_MAIN_CITY.REMARKS
  is '备注信息';
comment on column TEST_LINE_WEATHER_MAIN_CITY.DEL_FLAG
  is '逻辑删除标记（0：显示；1：隐藏）';
comment on column TEST_LINE_WEATHER_MAIN_CITY.DATESTR
  is '日期';
comment on column TEST_LINE_WEATHER_MAIN_CITY.BEIJING_MAXTEMP
  is '北京最高气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.BEIJING_MINTEMP
  is '北京最低气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.CHANGCHUN_MAXTEMP
  is '长春最高气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.CHANGCHUN_MINTEMP
  is '长春最低气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.SHENYANG_MAXTEMP
  is '沈阳最高气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.SHENYANG_MINTEMP
  is '沈阳最低气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.HAERBIN_MAXTEMP
  is '哈尔滨最高气温';
comment on column TEST_LINE_WEATHER_MAIN_CITY.HAERBIN_MINTEMP
  is '哈尔滨最低气温';

prompt Creating TEST_PIE_CLASS...
...
comment on table TEST_PIE_CLASS
  is '班级';
comment on column TEST_PIE_CLASS.ID
  is '主键';
comment on column TEST_PIE_CLASS.CREATE_BY
  is '创建者';
comment on column TEST_PIE_CLASS.CREATE_DATE
  is '创建时间';
comment on column TEST_PIE_CLASS.UPDATE_BY
  is '更新者';
comment on column TEST_PIE_CLASS.UPDATE_DATE
  is '更新时间';
comment on column TEST_PIE_CLASS.DEL_FLAG
  is '逻辑删除标记（0：显示；1：隐藏）';
comment on column TEST_PIE_CLASS.CLASS_NAME
  is '班级';
comment on column TEST_PIE_CLASS.NUM
  is '人数';
comment on column TEST_PIE_CLASS.REMARKS
  is '备注信息';
alter table TEST_PIE_CLASS
  add constraint PK_TEST_PIE_CLASS_ID primary key (ID)
  using index 
  tablespace USERS
  pctfree 10
  initrans 2
...
prompt Creating TEST_VALIDATION...
...
prompt Disabling triggers for GROUP_USER...
alter table GROUP_USER disable all triggers;
...
prompt Disabling triggers for TESTNOTE...
alter table TESTNOTE disable all triggers;
...
prompt Disabling triggers for TEST_LINE_WEATHER_MAIN_CITY...
alter table TEST_LINE_WEATHER_MAIN_CITY disable all triggers;
prompt Disabling triggers for TEST_PIE_CLASS...
alter table TEST_PIE_CLASS disable all triggers;
prompt Disabling triggers for TEST_TREE...
alter table TEST_TREE disable all triggers;
prompt Disabling triggers for TEST_VALIDATION...
alter table TEST_VALIDATION disable all triggers;
prompt Disabling triggers for T_GROUP...
alter table T_GROUP disable all triggers;
prompt Deleting T_GROUP...
delete from T_GROUP;
commit;
prompt Deleting TEST_VALIDATION...
delete from TEST_VALIDATION;
commit;
prompt Deleting TEST_TREE...
delete from TEST_TREE;
commit;
prompt Deleting TEST_PIE_CLASS...
delete from TEST_PIE_CLASS;
commit;
prompt Deleting TEST_LINE_WEATHER_MAIN_CITY...
...
commit;
prompt Deleting TESTNOTE...
delete from TESTNOTE;
commit;
...
values ('bf0d78a8f612439685b06c46e368d9bf', null, 'curd', 'com.jeeplus.modules', 'test', 'validation', '测试校验功能', '测试校验功能', 'lgf', '5fe33bf16844427d9fe61f6f2ef16859', '1', to_date('06-10-2016 18:48:00', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:00', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('117aa0aa8af0427dafe876c6ca8bf86f', null, 'curd', 'com.jeeplus.modules', 'test', 'note', '富文本测试', '富文本测试', 'liugf', 'e87f420bb47d4937bdfa83fc664a11cd', '1', to_date('22-06-2016 01:38:04', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:04', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('7958d14698494babbe338c401a751d29', null, 'curd', 'com.jeeplus.modules', 'test', 'grid', '商品类型', '商品类型', 'lgf', 'af61d61368db491cac85ba35e86edd6c', '1', to_date('22-06-2016 01:45:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:45:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('ad4a27a390174d9ab9d81b56c98a717a', null, 'curd', 'com.jeeplus.modules', 'test', 'grid', '商品', '商品', 'lgf', '7724e51bea0d4ff7be103d02333e4255', '1', to_date('22-06-2016 01:46:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:24', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('35ba95c3d13c47fcb70b92247d38ca7a', null, 'curd', 'com.jeeplus.modules', 'test', 'one', '员工请假', '请假单', 'liugf', '0a8f05eb973b4942af37c45109bd2502', '1', to_date('19-02-2016 15:35:52', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:50', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('a93238d2954a4da0a0a7a3c551803913', null, 'curd_many', 'com.jeeplus.modules', 'test', 'onetomany', '票务代理', '票务代理', 'liugf', 'e08d6fbc393047748a2d45c98be42676', '8b454376c0434e2792a1dc57edf80dbd', to_date('19-02-2016 15:35:52', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:18:02', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('621311f6fc13417a8fb81861db0c32e1', null, 'curd', 'com.jeeplus.modules', 'echarts', null, '班级', '班级', 'lgf', '4572e595aff6450fa9583a9302a8f2f6', '1', to_date('22-06-2016 02:07:59', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:07:59', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into GEN_SCHEME (ID, NAME, CATEGORY, PACKAGE_NAME, MODULE_NAME, SUB_MODULE_NAME, FUNCTION_NAME, FUNCTION_NAME_SIMPLE, FUNCTION_AUTHOR, GEN_TABLE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('30aa2c60b13c4f8fa2d2179a8ae60327', null, 'curd', 'com.jeeplus.modules', 'echarts', null, '综合报表2', '综合报表2', 'lgf', '84558c0de96b40dfb4ac94db4b0ff79a', '1', to_date('22-06-2016 02:09:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
commit;
...
values ('5fe33bf16844427d9fe61f6f2ef16859', 'test_validation', 'test_validation', 'TestValidation', null, null, '1', to_date('06-10-2016 18:46:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, '0');
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
values ('4572e595aff6450fa9583a9302a8f2f6', 'test_pie_class', '班级', 'PieClass', null, null, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', '0');
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
values ('84558c0de96b40dfb4ac94db4b0ff79a', 'test_line_weather_city', '城市气温', 'ChinaWeatherDataBean', null, null, '1', to_date('22-06-2016 01:54:20', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', '0');
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
values ('af61d61368db491cac85ba35e86edd6c', 'category', '商品类型', 'Category', null, null, '1', to_date('22-06-2016 01:45:14', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', '0');
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
values ('7724e51bea0d4ff7be103d02333e4255', 'goods', '商品', 'Goods', null, null, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', '0');
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
values ('0a8f05eb973b4942af37c45109bd2502', 'form_leave', '请假表单', 'FormLeave', null, null, '1', to_date('19-02-2016 15:50:23', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', '0');
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
...
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
values ('e08d6fbc393047748a2d45c98be42676', 'test_data_main', '票务代理', 'TestDataMain', null, null, '8b454376c0434e2792a1dc57edf80dbd', to_date('19-02-2016 15:50:23', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', '1');
insert into GEN_TABLE (ID, NAME, COMMENTS, CLASS_NAME, PARENT_TABLE, PARENT_TABLE_FK, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, ISSYNC, TABLE_TYPE)
values ('e87f420bb47d4937bdfa83fc664a11cd', 'testnote', '富文本测试', 'TestNote', null, null, '1', to_date('22-06-2016 01:33:30', 'dd-mm-yyyy hh24:mi:ss'), null, to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', '0');
commit;
prompt 12 records loaded
prompt Loading GEN_TABLE_COLUMN...
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('f5dbc48ab05a47a79175fa96582b725c', '4572e595aff6450fa9583a9302a8f2f6', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 4, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('c77b6863c00b4be5960e8fdf4349eba5', '4572e595aff6450fa9583a9302a8f2f6', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 5, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('6eb08271514847dab6191ddbe6a9eb89', '4572e595aff6450fa9583a9302a8f2f6', 'class_name', '班级', 'varchar(64)', 'String', 'className', '0', '1', '1', '1', '1', '1', 'like', 'input', null, null, 6, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('1f5bdd50ae8942b89b1512473e50a35b', '4572e595aff6450fa9583a9302a8f2f6', 'num', '人数', 'varchar(64)', 'Integer', 'num', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 7, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('97d814abd7f743dda91a3ce243d115a2', '4572e595aff6450fa9583a9302a8f2f6', 'remarks', '备注信息', 'nvarchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 8, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('739b584fb0ae4d02836468549fc3ff6a', 'e08d6fbc393047748a2d45c98be42676', 'id', '编号', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('554e74c7256544b59ec4bb1b9889055a', 'e08d6fbc393047748a2d45c98be42676', 'user_id', '归属用户', 'varchar(64)', 'String', 'tuser.id|name', '0', '0', '1', '1', '0', '0', '=', 'userselect', null, null, 1, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('98430241776b4f2ebf5b929c01365d76', 'e08d6fbc393047748a2d45c98be42676', 'office_id', '归属部门', 'varchar(64)', 'String', 'office.id|name', '0', '0', '1', '1', '1', '0', '=', 'officeselect', null, null, 2, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('cd0a3667f2c84f1eb648ae04dc7b3ce9', 'e08d6fbc393047748a2d45c98be42676', 'area_id', '归属区域', 'varchar(64)', 'String', 'area.id|name', '0', '0', '1', '1', '1', '0', '=', 'areaselect', null, null, 3, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('aaabdbb22ef5465f86d6d735faf335aa', 'e08d6fbc393047748a2d45c98be42676', 'name', '名称', 'varchar(100)', 'String', 'name', '0', '0', '1', '1', '1', '1', 'like', 'input', null, null, 4, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('98564db10dca4a95aac542130310ac6e', 'e08d6fbc393047748a2d45c98be42676', 'sex', '性别', 'char(1)', 'String', 'sex', '0', '0', '1', '1', '1', '1', '=', 'radiobox', 'sex', null, 5, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('5d64e3171afa4a91896ebe2f1a921d85', 'e08d6fbc393047748a2d45c98be42676', 'in_date', '加入日期', 'date', 'java.util.Date', 'inDate', '0', '0', '1', '1', '1', '1', 'between', 'dateselect', null, null, 6, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('b833ee4652a042f7be93d84e2b507741', 'e08d6fbc393047748a2d45c98be42676', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 7, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('89c00ad102cb403dba4ce1b9c2d8177d', 'e08d6fbc393047748a2d45c98be42676', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '1', '1', '0', '=', 'dateselect', null, null, 8, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('c4d37675e7c3449d89095a9aa4fca511', 'e08d6fbc393047748a2d45c98be42676', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 9, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('68a336b3dce740f0b4c63c8e289deed0', 'e08d6fbc393047748a2d45c98be42676', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '1', '1', '=', 'dateselect', null, null, 10, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('681695a6a6b24d15b2b2b98e7fee4115', 'e08d6fbc393047748a2d45c98be42676', 'remarks', '备注信息', 'varchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 11, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ce4ad4c1db634753bce945391f08c096', 'e08d6fbc393047748a2d45c98be42676', 'del_flag', '删除标记', 'char(1)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 12, '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:14', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('f62f64bee9534cbdbddf454c5f074338', '0a8f05eb973b4942af37c45109bd2502', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('1cd7ed7f7c814882a989b0b4701f995c', '0a8f05eb973b4942af37c45109bd2502', 'user_id', '员工', 'varchar(64)', 'com.jeeplus.modules.sys.entity.User', 'tuser.id|name', '0', '0', '1', '1', '1', '1', '=', 'userselect', null, null, 1, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('b05dd1742e364cd28eba438a2b28c197', '0a8f05eb973b4942af37c45109bd2502', 'office_id', '归属部门', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Office', 'office.id|name', '0', '0', '1', '1', '1', '0', '=', 'officeselect', null, null, 2, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('08de1c8f6df64dc0b21a8b790e74ab8b', '0a8f05eb973b4942af37c45109bd2502', 'area_id', '归属区域', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Area', 'area.id|name', '0', '1', '1', '1', '1', '0', '=', 'areaselect', null, null, 3, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('346c70e2a6f64cb3b170a5443ea38f6f', '0a8f05eb973b4942af37c45109bd2502', 'begin_date', '请假开始日期', 'datetime', 'java.util.Date', 'beginDate', '0', '0', '1', '1', '1', '0', '=', 'dateselect', null, null, 4, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('2319a91700fe4947abe11aeef210626d', '0a8f05eb973b4942af37c45109bd2502', 'end_date', '请假结束日期', 'datetime', 'java.util.Date', 'endDate', '0', '0', '1', '1', '1', '0', '=', 'dateselect', null, null, 5, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('990ef0c7175d4fdea8253799e38e6f59', '0a8f05eb973b4942af37c45109bd2502', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 6, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ce0388afa7ac4a059045423320cbcf23', '0a8f05eb973b4942af37c45109bd2502', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 7, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('9d5871f8815e4b158a498e2faa4ee140', '0a8f05eb973b4942af37c45109bd2502', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 8, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('8d7e9a9e59c043a38d29d53e32e41c6c', '0a8f05eb973b4942af37c45109bd2502', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 9, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('84b8e77d91c94fc2b5f881ea1a92702c', '0a8f05eb973b4942af37c45109bd2502', 'remarks', '备注信息', 'nvarchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 10, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('5f849be3cc224b55ba82ce7687303ec3', '0a8f05eb973b4942af37c45109bd2502', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 11, '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:17:45', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('491400692b30439396025a63d9b72510', 'e87f420bb47d4937bdfa83fc664a11cd', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('6c8710662283466a94a81ff0336daa53', 'e87f420bb47d4937bdfa83fc664a11cd', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 1, '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('156da47d064b4b338b31b51f81abe18b', 'e87f420bb47d4937bdfa83fc664a11cd', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 2, '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('d8b0b97771e348a892209a0e027b5957', 'e87f420bb47d4937bdfa83fc664a11cd', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 3, '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:00', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('3aa953eb3cd5438fa6a9445d5f980473', 'e87f420bb47d4937bdfa83fc664a11cd', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 4, '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('2ba3f32163f24065a7388fee616326d1', 'e87f420bb47d4937bdfa83fc664a11cd', 'remarks', '备注信息', 'nvarchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 5, '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ac097af9f0ad42d9b54a5f3ded6f7978', 'e87f420bb47d4937bdfa83fc664a11cd', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 6, '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('804f4e8c00fd471c80a77305253b716c', 'e87f420bb47d4937bdfa83fc664a11cd', 'title', '标题', 'varchar(64)', 'String', 'title', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 7, '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('01199a273808452a96bdc9b279fd55f1', 'e87f420bb47d4937bdfa83fc664a11cd', 'contents', '内容', 'blob', 'String', 'contents', '0', '1', '1', '1', '1', '0', '=', 'umeditor', null, null, 8, '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:01', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e008195c1fa149a982e5961f27ee96ed', 'af61d61368db491cac85ba35e86edd6c', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('043d123f5aa440398099ee0e998c8d5f', 'af61d61368db491cac85ba35e86edd6c', 'name', '类型名', 'varchar(64)', 'String', 'name', '0', '1', '1', '1', '1', '1', 'like', 'input', null, null, 1, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('4dde85f94e4749c581fe5c49d171b335', 'af61d61368db491cac85ba35e86edd6c', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 2, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('a68e42aa8b8d471997390bf2e2c7e161', 'af61d61368db491cac85ba35e86edd6c', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 3, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('63ae74ba927d461095e8b10a4030caec', 'af61d61368db491cac85ba35e86edd6c', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 4, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('9ee7f4d7c08f41aca198ee7d105efbe5', 'af61d61368db491cac85ba35e86edd6c', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 5, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('6a9d0e75045940438fe45367c4e0b97d', 'af61d61368db491cac85ba35e86edd6c', 'remarks', '备注信息', 'nvarchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 6, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('a29b629f272f45e1b0c856da67c0e1b5', 'af61d61368db491cac85ba35e86edd6c', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 7, '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:31:57', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e1d1f1aea67e488897e59fe17df8d7d4', '5fe33bf16844427d9fe61f6f2ef16859', 'id', 'id', 'nvarchar2(255)', 'String', 'id', '0', '1', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('c190afd0ac4c46d09949781762921e1f', '5fe33bf16844427d9fe61f6f2ef16859', 'num', 'num', 'long', 'String', 'num', '0', '1', '1', '1', '0', '0', '=', 'input', null, null, 1, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('353bf5c044424f5883cc2250b2909a77', '5fe33bf16844427d9fe61f6f2ef16859', 'num2', 'num2', 'number(18)', 'Long', 'num2', '0', '1', '1', '1', '0', '0', '=', 'input', null, null, 2, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('0dd3576119f74286b5a130673996748a', '5fe33bf16844427d9fe61f6f2ef16859', 'str', 'str', 'nvarchar2(255)', 'String', 'str', '0', '1', '1', '1', '0', '0', '=', 'input', null, null, 3, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('9672fbd1e40f43dfaca1a7befb9d0e78', '5fe33bf16844427d9fe61f6f2ef16859', 'email', 'email', 'nvarchar2(255)', 'String', 'email', '0', '1', '1', '1', '0', '0', '=', 'input', null, null, 4, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('435ae24b583242ba9fed0c76596915e0', '5fe33bf16844427d9fe61f6f2ef16859', 'url', 'url', 'nvarchar2(255)', 'String', 'url', '0', '1', '1', '1', '0', '0', '=', 'input', null, null, 5, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('b25829ee08df4e5686516a627fbb0a1c', '5fe33bf16844427d9fe61f6f2ef16859', 'new_date', 'new_date', 'date(7)', 'java.util.Date', 'newDate', '0', '1', '1', '1', '0', '0', '=', 'input', null, null, 6, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('fb7c7a3e80b44f408c2bcbe801bd4269', '5fe33bf16844427d9fe61f6f2ef16859', 'remarks', 'remarks', 'nvarchar2(255)', 'Long', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 7, '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:47:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('351be6aa79f24f518495b2f6254469ec', 'bae082dbd74a4ca381c0ad24c886f991', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 5, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('5e9e23d21e5c4c9f8e66f13fccc94b00', 'bae082dbd74a4ca381c0ad24c886f991', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 10, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('61b9e66dd1474136ba1cfdc527b0d5a1', 'bae082dbd74a4ca381c0ad24c886f991', 'sort', '排序', 'decimal(10,0)', 'Integer', 'sort', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 2, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('65162403a536499d813f4743f299bb08', 'bae082dbd74a4ca381c0ad24c886f991', 'name', '名称', 'varchar(100)', 'String', 'name', '0', '0', '1', '1', '1', '1', 'like', 'input', null, null, 1, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('7b2eddb13f244912a616d0e5d8cf2cd7', 'bae082dbd74a4ca381c0ad24c886f991', 'parent_ids', '所有父级编号', 'varchar(2000)', 'String', 'parentIds', '0', '0', '1', '1', '0', '0', 'like', 'input', null, null, 4, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('884b8d5814ef4010a8c712402dda8d4c', 'bae082dbd74a4ca381c0ad24c886f991', 'remarks', '备注信息', 'varchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 9, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('979d48a6e2e948ccb3ad904a754ef010', 'bae082dbd74a4ca381c0ad24c886f991', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 8, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('aa63196cc78045b0a6f7a990230b8314', 'bae082dbd74a4ca381c0ad24c886f991', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 6, '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:09', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('d7de5681415940178d026805e4dae92c', 'bae082dbd74a4ca381c0ad24c886f991', 'parent_id', '父级编号', 'varchar(64)', 'This', 'parent.id|name', '0', '0', '1', '1', '0', '0', '=', 'treeselect', null, null, 3, '1', to_date('19-02-2016 16:05:10', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:10', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e72843f6c5834fce925e0bf6f43a2df2', 'bae082dbd74a4ca381c0ad24c886f991', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('19-02-2016 16:05:10', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:10', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('f91b8587c39d41d98339d9f5ce2d51bc', 'bae082dbd74a4ca381c0ad24c886f991', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 7, '1', to_date('19-02-2016 16:05:10', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('19-02-2016 16:05:10', 'dd-mm-yyyy hh24:mi:ss'), null, '0', null, null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('2f620a191ac8458fb9a6bd470c962961', '84558c0de96b40dfb4ac94db4b0ff79a', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('df75566842a049dbbb780a89ba951da0', '84558c0de96b40dfb4ac94db4b0ff79a', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 1, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('0a0d27c208ca4298a8f4912c16f51ad3', '84558c0de96b40dfb4ac94db4b0ff79a', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 2, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('52c24380cb0c495b98a3706de044a354', '84558c0de96b40dfb4ac94db4b0ff79a', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 3, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ff72d7707ebf44feb8436d40b81b0857', '84558c0de96b40dfb4ac94db4b0ff79a', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 4, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e76e22bbdf4840398039ee4016e22e6d', '84558c0de96b40dfb4ac94db4b0ff79a', 'remarks', '备注信息', 'nvarchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 5, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('12f1117a95924a5c8eab50425cea272d', '84558c0de96b40dfb4ac94db4b0ff79a', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 6, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e9b6d7129393434a9d51b968a935ac88', '84558c0de96b40dfb4ac94db4b0ff79a', 'datestr', '日期', 'datetime', 'java.util.Date', 'datestr', '0', '1', '1', '1', '1', '0', '=', 'dateselect', null, null, 7, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('48e96ed611c1467b90828daaeed02ca8', '84558c0de96b40dfb4ac94db4b0ff79a', 'beijing_maxtemp', '北京最高气温', 'double', 'Double', 'beijingMaxTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 8, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e4b40aa8ac324b71bea083382a7420b1', '84558c0de96b40dfb4ac94db4b0ff79a', 'beijing_mintemp', '北京最低气温', 'double', 'Double', 'beijingMinTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 9, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ecd932ed4f2b43ffb4bb58bc60c94855', '84558c0de96b40dfb4ac94db4b0ff79a', 'changchun_maxtemp', '长春最高气温', 'double', 'Double', 'changchunMaxTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 10, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('1555aa9aa5684aa0a2dab99880eb4fae', '84558c0de96b40dfb4ac94db4b0ff79a', 'changchun_mintemp', '长春最低气温', 'double', 'Double', 'changchunMinTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 11, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e47ab27d14da4de4a3b1fbe155313b7c', '84558c0de96b40dfb4ac94db4b0ff79a', 'shenyang_maxtemp', '沈阳最高气温', 'double', 'Double', 'shenyangMaxTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 12, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('9324dfd89fb14472872a63575cc44f6a', '84558c0de96b40dfb4ac94db4b0ff79a', 'shenyang_mintemp', '沈阳最低气温', 'double', 'Double', 'shenyangMinTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 13, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('19a1a81866a0489c94feaa86b43ad5d9', '84558c0de96b40dfb4ac94db4b0ff79a', 'haerbin_maxtemp', '哈尔滨最高气温', 'double', 'Double', 'haerbinMaxTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 14, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('5b0cdc6595924f5a8bff3894b35c7fae', '84558c0de96b40dfb4ac94db4b0ff79a', 'haerbin_mintemp', '哈尔滨最低气温', 'double', 'Double', 'haerbinMinTemp', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 15, '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:58:27', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('8e5066127de9438d88365bd18d46f271', '73326f175c2d4a63b2d89820a79ba2eb', 'startarea', '出发地', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Area', 'startArea.id|name', '0', '0', '1', '1', '1', '1', '=', 'areaselect', null, null, 1, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('415e118871bc4db0ad26873a596502ca', '73326f175c2d4a63b2d89820a79ba2eb', 'endarea', '目的地', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Area', 'endArea.id|name', '0', '0', '1', '1', '1', '1', '=', 'areaselect', null, null, 2, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('67a13270c0b0408c8a3a2db9df50b1a6', '73326f175c2d4a63b2d89820a79ba2eb', 'price', '代理价格', 'double', 'Double', 'price', '0', '0', '1', '1', '1', '0', '=', 'input', null, null, 3, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('0018d41c4ecb40d4ae941edad2225fd0', '73326f175c2d4a63b2d89820a79ba2eb', 'test_data_main_id', '业务主表ID', 'varchar(64)', 'String', 'testDataMain.id', '0', '1', '1', '1', '0', '0', '=', 'input', null, null, 4, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('3750bb51b7164acd84437af24cc19164', '73326f175c2d4a63b2d89820a79ba2eb', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 5, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('93e05418d2f04ba7aecebb65bfc5ce56', '73326f175c2d4a63b2d89820a79ba2eb', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 6, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('7bf190f64a304caaa8f1616e6544358b', '73326f175c2d4a63b2d89820a79ba2eb', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 7, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('a471967f18354c9b82764e6a17950f59', '73326f175c2d4a63b2d89820a79ba2eb', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '1', '0', '=', 'dateselect', null, null, 8, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('9dc8f2cd97da4732adf14d986975fd94', '73326f175c2d4a63b2d89820a79ba2eb', 'remarks', '备注信息', 'varchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 9, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('271a7ae9f0ab4c19bf27fcfd3f51447a', '73326f175c2d4a63b2d89820a79ba2eb', 'del_flag', '删除标记', 'char(1)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 10, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('bb6e30240e3349b29d9ff69da44ae786', '90d8fc88828d47a99fcbfeaa4f95f0db', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '0', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('d4b18b2f89dc45e3b7c21b05be2708e3', '90d8fc88828d47a99fcbfeaa4f95f0db', 'startarea', '出发地', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Area', 'startArea.id|name', '0', '0', '1', '1', '1', '1', '=', 'areaselect', null, null, 1, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('bd7d6b60b7f745d78275729fe9ddc6b2', '90d8fc88828d47a99fcbfeaa4f95f0db', 'endarea', '目的地', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Area', 'endArea.id|name', '0', '0', '1', '1', '1', '1', '=', 'areaselect', null, null, 2, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('59d0fb96d8b24555bd2aafe7b60d283b', '90d8fc88828d47a99fcbfeaa4f95f0db', 'price', '代理价格', 'double', 'Double', 'price', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 3, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('619b7299f38a4fceb15677634889082d', '90d8fc88828d47a99fcbfeaa4f95f0db', 'test_data_main', '外键', 'varchar(64)', 'String', 'testDataMain.id', '0', '0', '1', '1', '1', '0', '=', 'input', null, null, 4, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('1dae911ed0a84c99bc43a47148c5cb34', '90d8fc88828d47a99fcbfeaa4f95f0db', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 5, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('748fd7e08a484b2d90d591566e4f8538', '90d8fc88828d47a99fcbfeaa4f95f0db', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 6, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('47d244ffe10347acbc7f7d6a7a0f25c2', '90d8fc88828d47a99fcbfeaa4f95f0db', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 7, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
commit;
prompt 100 records committed...
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('20ea8fa788ec4014bdb530d7a699834a', '90d8fc88828d47a99fcbfeaa4f95f0db', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '1', '0', '=', 'dateselect', null, null, 8, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('20f858a55ffd423db9b99a6a94f77c02', '90d8fc88828d47a99fcbfeaa4f95f0db', 'remarks', '备注信息', 'varchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 9, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('2391c068e8644288b58cba7558f58e11', '90d8fc88828d47a99fcbfeaa4f95f0db', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 10, '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:22', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('93c94fd73d0c4c53aff48a4dc18bf45d', '3f7c20cfa7b840dc854d9ea27f4de539', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('f9d4693442ab47b0842f12d80441f566', '3f7c20cfa7b840dc854d9ea27f4de539', 'startarea', '出发地', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Area', 'startArea.id|name', '0', '0', '1', '1', '1', '1', '=', 'areaselect', null, null, 1, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('d1d0c27e186f40999f4ff61820b80fa2', '3f7c20cfa7b840dc854d9ea27f4de539', 'endarea', '目的地', 'varchar(64)', 'com.jeeplus.modules.sys.entity.Area', 'endArea.id|name', '0', '0', '1', '1', '1', '1', '=', 'areaselect', null, null, 2, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('1f06396999b94c92b61631900e5f1e30', '3f7c20cfa7b840dc854d9ea27f4de539', 'price', '代理价格', 'double', 'Double', 'price', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 3, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('d0debb6a16ef4079a22db8e7db77d63e', '3f7c20cfa7b840dc854d9ea27f4de539', 'test_data_main', '外键', 'varchar(64)', 'String', 'testDataMain.id', '0', '0', '1', '1', '1', '0', '=', 'input', null, null, 4, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ae5c6301e623476287c24a54eaa28ede', '3f7c20cfa7b840dc854d9ea27f4de539', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 5, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('9d47f247a524408884d38fec50b12562', '3f7c20cfa7b840dc854d9ea27f4de539', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 6, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('58afb6fb6ad444adab24ce50d8881ef2', '3f7c20cfa7b840dc854d9ea27f4de539', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 7, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('7367af53b3b6461dabef66c805e4f4f1', '3f7c20cfa7b840dc854d9ea27f4de539', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 8, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('08249f166ed84f25a47d8109c5a0cab7', '3f7c20cfa7b840dc854d9ea27f4de539', 'remarks', '备注信息', 'nvarchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 9, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('97b78110efa34638a6c2e4c095ee358d', '73326f175c2d4a63b2d89820a79ba2eb', 'id', '编号', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:22:58', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ab391737ca174eab80e760f13b2b7fbc', '3f7c20cfa7b840dc854d9ea27f4de539', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 10, '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('09-05-2016 02:23:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('2ebebc6f0f6f433bbb1b8b805b4f528e', '7724e51bea0d4ff7be103d02333e4255', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('2b301773239e426a918c251ff11172b3', '7724e51bea0d4ff7be103d02333e4255', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 1, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('f739b0402f99428d89cc3db03b7d3022', '7724e51bea0d4ff7be103d02333e4255', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 2, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('04a76da12fdb4468856195d0ff684fbb', '7724e51bea0d4ff7be103d02333e4255', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 3, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('a0e0dd77547548f2bf53c37efd267dfc', '7724e51bea0d4ff7be103d02333e4255', 'update_date', '更新时间', 'datetime', 'java.util.Date', 'updateDate', '0', '0', '1', '1', '0', '0', '=', 'dateselect', null, null, 4, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('4cc5312e50a8402bb444618510e64801', '7724e51bea0d4ff7be103d02333e4255', 'remarks', '备注信息', 'nvarchar(255)', 'String', 'remarks', '0', '1', '1', '1', '1', '0', '=', 'textarea', null, null, 5, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e1437cb8bcd44c888edd86a651e5f2da', '7724e51bea0d4ff7be103d02333e4255', 'del_flag', '逻辑删除标记（0：显示；1：隐藏）', 'varchar(64)', 'String', 'delFlag', '0', '0', '1', '0', '0', '0', '=', 'radiobox', 'del_flag', null, 6, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('0ffd134d40d24dd3885493c01ea1b708', '7724e51bea0d4ff7be103d02333e4255', 'name', '商品名称', 'varchar(64)', 'String', 'name', '0', '1', '1', '1', '1', '1', '=', 'input', null, null, 7, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('bf3b88d5d2a34770890609cacbf734fe', '7724e51bea0d4ff7be103d02333e4255', 'category_id', '所属类型', 'varchar(64)', 'com.jeeplus.modules.test.entity.grid.Category', 'category.id|name', '0', '1', '1', '1', '1', '1', '=', 'gridselect', null, null, 8, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', 'category', '商品分类|备注', 'name|remarks', '分类名', 'name', null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('9794ce1a62e443ebadec9f95585ee8a1', '7724e51bea0d4ff7be103d02333e4255', 'price', '价格', 'varchar(64)', 'String', 'price', '0', '1', '1', '1', '1', '0', '=', 'input', null, null, 9, '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:43:12', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '1', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('2c0c0314433d4840bb10fdb09345a5a5', '4572e595aff6450fa9583a9302a8f2f6', 'create_by', '创建者', 'varchar(64)', 'String', 'createBy.id', '0', '0', '1', '0', '0', '0', '=', 'input', null, null, 1, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('ec6e726df2f344c5be2963f5cef7ab78', '4572e595aff6450fa9583a9302a8f2f6', 'create_date', '创建时间', 'datetime', 'java.util.Date', 'createDate', '0', '0', '1', '0', '0', '0', '=', 'dateselect', null, null, 2, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('88572973e6694eb8be9569caa096ded3', '4572e595aff6450fa9583a9302a8f2f6', 'id', '主键', 'varchar(64)', 'String', 'id', '1', '0', '1', '0', '0', '0', '=', 'input', null, null, 0, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
insert into GEN_TABLE_COLUMN (ID, GEN_TABLE_ID, NAME, COMMENTS, JDBC_TYPE, JAVA_TYPE, JAVA_FIELD, IS_PK, IS_NULL, IS_INSERT, IS_EDIT, IS_LIST, IS_QUERY, QUERY_TYPE, SHOW_TYPE, DICT_TYPE, SETTINGS, SORT, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, IS_FORM, TABLENAME, FIELDLABELS, FIELDKEYS, SEARCHLABEL, SEARCHKEY, VALIDATETYPE, MIN_LENGTH, MAX_LENGTH, MIN_VALUE, MAX_VALUE)
values ('e51444f52c7f48498442af21fc4e2a90', '4572e595aff6450fa9583a9302a8f2f6', 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy.id', '0', '0', '1', '1', '0', '0', '=', 'input', null, null, 3, '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:49:05', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '0', null, null, null, null, null, null, null, null, null, null);
commit;
...
values ('0', '0', ',,', null, null, null, null, null, '1', to_date('06-10-2016 18:49:44', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
commit;
prompt 1 records loaded
prompt Loading GOODS...
prompt Table is empty
prompt Loading GROUP_USER...
prompt Table is empty
...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('875cdbc2650f4427b991bacbedb3239d', '1', 'ONLINE开发-生成示例-商品类型', '1', to_date('22-06-2016 01:47:00', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/category', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('f84e4f843d5e4a789e25fc5e80452157', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 01:47:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4901d1975e564caebb5b35ad8bd45262', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:49:08', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=4572e595aff6450fa9583a9302a8f2f6', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('fa861afc477e42a3b29109a1cec9ff27', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:54:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('760d798b519b4f14a1f21ca31f3ed4d3', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:54:51', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('34e43005556b409a820a89dda9efe262', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:55:43', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('deafca89ebf94d8a8624786491e0c1ed', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:56:02', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e33c8085f2004f36bbdba4da95e95bd6', '1', '系统登录', '1', to_date('22-06-2016 01:58:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/form', 'GET', 'id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('53e64171ba4f4dff95cbc6efbf0132fb', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 02:02:57', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('eb93e8953d904f4785315ddf0c653c6a', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 02:03:02', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e4e1c5623457408890df79a4d58a92de', '1', '系统设置-用户管理', '1', to_date('22-06-2016 02:03:17', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/user/index', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('050ad0c37b6847f6aed5a752f0c39ac9', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:03:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a7e3f7fb0e1e4aa799cff2952efb1dfb', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:05:53', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('c551f820e68e4277a7030f49de287bea', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:06:18', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('8fcab0353f574b24b314aea339f1706f', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:06:35', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('96aebb2cd03e4dd488dd386e15c468c6', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:06:50', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ba3a6714db234ccc822e9953783235e7', '1', '系统登录', '1', to_date('22-06-2016 02:10:35', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('df2bc540a7d84634a344ed87b20209a5', '1', '统计报表-柱状图', '1', to_date('22-06-2016 02:10:37', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/bar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a904076c759d4d5cb425ef9d812b8492', '1', '统计报表-折线图', '1', to_date('22-06-2016 02:10:38', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/line', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('cb459390cf4f469b9cce1e27e8aea45f', '1', '统计报表-双数值轴折线图', '1', to_date('22-06-2016 02:10:40', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/linedoublenum', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('89939b2be8484d3d825d04fc078edead', '1', '系统登录', '1', to_date('22-06-2016 02:13:18', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('1fa2a4153a2744caa6cd07da2701d4bf', '1', '统计报表-双数值轴折线图', '1', to_date('22-06-2016 02:13:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/linedoublenum', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4e44450bbaee424c9be7f659cf6096f6', '1', '统计报表-折线图', '1', to_date('22-06-2016 02:13:22', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/line', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('d6404746eb974978a2f9882824b5c3b9', '1', '统计报表-柱状图', '1', to_date('22-06-2016 02:13:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/bar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4adb698e2c44405e922e4194e1b770eb', '1', '统计报表-饼图', '1', to_date('22-06-2016 02:13:25', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pie', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('898a764a829f4f6981d00a9931682030', '1', '统计报表-玫瑰图', '1', to_date('22-06-2016 02:13:26', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/radar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('0c0ee2d64b68478fb406d58e65e83639', '1', '统计报表-综合报表1', '1', to_date('22-06-2016 02:13:27', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pieClass', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('c0d3a0aed7194e4680ca764b8e6e392f', '1', '统计报表-综合报表2', '1', to_date('22-06-2016 02:13:29', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/chinaWeatherDataBean', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('86b55fef6bd34d8c8c54dc1c71c19666', '1', '统计报表-玫瑰图', '1', to_date('22-06-2016 02:15:18', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/radar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('5dbbd6cf086546a28b5db375042428be', '1', '统计报表-综合报表1', '1', to_date('22-06-2016 02:15:18', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pieClass', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('49e94994da34430d93a50e42c8f96623', '1', '代码生成-生成示例-票务代理(一对多）', '1', to_date('22-06-2016 02:15:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b8a08c94ace247c38e60659ad10cfce6', '1', '统计报表-柱状图', '1', to_date('22-06-2016 02:15:16', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/bar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('147ccc079afd4646a87409bb3840eb11', '1', '统计报表-折线图', '1', to_date('22-06-2016 02:15:16', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/line', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4428a62f15174b24b7116d889c028a06', '1', '统计报表-饼图', '1', to_date('22-06-2016 02:15:17', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pie', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('050dceead8e74e6dbafa3a181c372b57', '1', 'ONLINE开发-生成示例-请假表单(单表）', '1', to_date('22-06-2016 01:29:45', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('bb9e752a09ee4b0baf5b3a02cdd5c129', '1', 'ONLINE开发-生成示例-组织结构(树结构)', '1', to_date('22-06-2016 01:29:47', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('3e94bdbf792e43fabe3cbb2da95f1818', '1', '我的面板-个人信息', '1', to_date('22-06-2016 01:29:58', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/user/info', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('1a4366f33d234d729521cc24e958f454', '1', '常用工具-接口测试-接口列表', '1', to_date('22-06-2016 01:30:05', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/testInterface', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('21836326780e437a9c00ba6beaadb0c7', '1', '常用工具-接口测试-接口测试', '1', to_date('22-06-2016 01:30:06', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/testInterface/test', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7c440ea174e54344892d35b9cf91cdae', '1', 'ONLINE开发-生成示例-富文本测试', '1', to_date('22-06-2016 01:38:25', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b5932375f4044f6b895d8f20804cc7b9', '1', '系统登录', '1', to_date('22-06-2016 01:38:30', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('83ebf3535b2c42da8b373f88be37d227', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 01:39:20', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('0dfc461771784288a9d2c9030954f5ea', '1', 'ONLINE开发-表单配置-导入', '1', to_date('22-06-2016 01:39:29', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/importTableFromDB', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('6ed1dc89b26f4cc3a8e523e9e2142c02', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:43:15', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=7724e51bea0d4ff7be103d02333e4255', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('c648288adc5845179d36c7158e2f9d8d', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:45:16', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=af61d61368db491cac85ba35e86edd6c', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('9155288c56d84986a040948f4b7e310c', '1', '系统登录', '1', to_date('22-06-2016 01:13:37', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('77f0f2ccfb474c41bfb338c789684f8e', '1', '系统登录', '1', to_date('22-06-2016 01:14:19', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2cc43614c0694a13a008efaa67548b2a', '1', 'ONLINE开发-生成示例-票务代理(一对多）', '1', to_date('22-06-2016 01:14:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a9761e53fc24469885d423ea6ec1c0e5', '1', 'ONLINE开发-生成示例-组织结构(树结构)', '1', to_date('22-06-2016 01:14:28', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b6148455075c4d0b939d8bbe949f13d4', '1', 'ONLINE开发-生成示例-请假表单(单表）', '1', to_date('22-06-2016 01:14:31', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2d213de09b2346bfa94ddb2f8a754322', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 01:15:34', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('fc8408299df0477ba381948a7b14573a', '1', 'ONLINE开发-生成示例-组织结构(树结构)', '1', to_date('22-06-2016 01:15:39', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4ca20f1fe0a047579f32e3696829e8fc', '1', 'ONLINE开发-生成示例-票务代理(一对多）', '1', to_date('22-06-2016 01:15:44', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('6a1c84276f1c4ce592d0aba1f94f84da', '1', 'ONLINE开发-表单配置-生成代码', '1', to_date('22-06-2016 01:17:48', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=0a8f05eb973b4942af37c45109bd2502', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ce9b6332718e4aac9f9b7da9ab89fbc2', '1', 'ONLINE开发-表单配置-生成代码', '1', to_date('22-06-2016 01:17:58', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=e08d6fbc393047748a2d45c98be42676', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('84798449df5f4bf1bfc7b0ff7032d0a6', '1', '常用工具-表单构建器', '1', to_date('22-06-2016 01:30:07', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/beautifyhtml', 'GET', null, null);
commit;
prompt 500 records committed...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('49e61f91354a455ba1892ea16d803c02', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 01:34:51', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('8ae08844c630449e9d4a224e17c97732', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:34:54', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=e87f420bb47d4937bdfa83fc664a11cd', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('6727e48cd34443bca16a7a2297888638', '1', 'ONLINE开发-生成示例-票务代理(一对多）', '1', to_date('22-06-2016 01:35:22', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a6b2c43f2bd245859ae748832b93d67d', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:35:28', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=0a8f05eb973b4942af37c45109bd2502', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('bd4b972bb4154d5f9561248fad9ecd78', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:35:48', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=e87f420bb47d4937bdfa83fc664a11cd', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('8822307074794aa5b4196b356ca9fd90', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:35:58', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=e87f420bb47d4937bdfa83fc664a11cd', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('946f8251ffc543d99650a59caaa40502', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:37:00', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=e87f420bb47d4937bdfa83fc664a11cd', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e978105fb79d4bb38e9ff59de77bbe7c', '1', 'ONLINE开发-表单配置-生成代码', '1', to_date('22-06-2016 01:37:15', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=e87f420bb47d4937bdfa83fc664a11cd', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('54a3a03adad447fb8e88b9b8bbd3df3b', '1', 'ONLINE开发-表单配置-生成代码', '1', to_date('22-06-2016 01:45:19', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=af61d61368db491cac85ba35e86edd6c', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b98c13898d904e41ac657266de1e92ff', '1', 'ONLINE开发-表单配置-生成代码', '1', to_date('22-06-2016 01:46:05', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=7724e51bea0d4ff7be103d02333e4255', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('0663c1ab53504896b3567a14cccb7d25', '1', '系统登录', '1', to_date('06-10-2016 18:31:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('0f78f0d610bc4b4d89a22fd0c9e569ed', '1', '统计报表-折线图', '1', to_date('06-10-2016 18:31:27', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/line', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('cd3b52001f1442db84198ca65c6e7618', '1', '统计报表-柱状图', '1', to_date('06-10-2016 18:31:28', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/bar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('06226075aa514951a3841556ebc7763b', '1', '统计报表-双数值轴折线图', '1', to_date('06-10-2016 18:31:29', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/linedoublenum', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ad54257110174ec69dab9c96d550b344', '1', '统计报表-饼图', '1', to_date('06-10-2016 18:31:30', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pie', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('f006faff1fb0401c9e8c176b0ce8ffc0', '1', '统计报表-综合报表1', '1', to_date('06-10-2016 18:31:31', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pieClass', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b942495308ec4a3eb548b324218c23b4', '1', '统计报表-综合报表2', '1', to_date('06-10-2016 18:31:31', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/chinaWeatherDataBean', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('8272a0dbcaf64ddbb6f1f50d7fee865d', '1', '代码生成-表单配置', '1', to_date('06-10-2016 18:31:38', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('c2006b1ca94a43fca51fbb87c9bf1b4b', '1', '代码生成-表单配置-同步数据库', '1', to_date('06-10-2016 18:32:09', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=af61d61368db491cac85ba35e86edd6c', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('0c559cea4cbd4691ab7370c19cb57670', '1', '代码生成-生成示例-商品', '1', to_date('06-10-2016 18:32:16', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('98db3342e99248edbe5aacfc921a1721', '1', '代码生成-生成示例-富文本测试', '1', to_date('06-10-2016 18:32:28', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2af3dfc9a10c46bf8cad009d18a0466f', '1', '代码生成-生成示例-组织结构(树结构)', '1', to_date('22-06-2016 02:15:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('964a8276c8bf4ac18f969a9c7f1beb4f', '1', '代码生成-生成示例-请假表单(单表）', '1', to_date('22-06-2016 02:15:22', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4a17749fbdcf43f8b17cb8eb1b6c1483', '1', '代码生成-生成示例-商品类型', '1', to_date('22-06-2016 02:15:23', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/category', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('35e7acb18e4247b2a642be9acedc51ab', '1', '代码生成-生成示例-商品', '1', to_date('22-06-2016 02:15:23', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e3305114e8cb444dbe58c388ccb24e0c', '1', '代码生成-生成示例-富文本测试', '1', to_date('22-06-2016 02:15:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('30cd64ecff154f1298af2c4004de964a', '1', '我的面板-个人信息', '1', to_date('22-06-2016 02:15:25', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/user/info', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('de96f6b7c35d4cc983337f0d86267294', '1', '我的面板-通讯录', '1', to_date('22-06-2016 02:15:26', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/contact/index', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7aa730d60f914fd3acacbf48ef1964cd', '1', '我的面板-常用联系人', '1', to_date('22-06-2016 02:15:27', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/contact/myFriends', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e34833badc2540259049474c9cea771e', '1', '系统监控-系统配置', '1', to_date('22-06-2016 02:15:32', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/systemConfig', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('9015ffd278ef43e68889f53d0787e5f2', '1', '系统监控-系统监控管理', '1', to_date('22-06-2016 02:15:34', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/monitor/info', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e79bf73564fc403e9927c2265727498c', '1', '常用工具-二维码测试', '1', to_date('22-06-2016 02:15:36', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/TwoDimensionCodeController', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('d513519ae7ab4398921e8f63e2396c47', '1', '常用工具-表单构建器', '1', to_date('22-06-2016 02:15:36', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/beautifyhtml', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('44fc65b8bcf7473a87008fce00476cdb', '1', '常用工具-短信工具', '1', to_date('22-06-2016 02:15:37', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/sms', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('730fba18f7e844dfa60150982ccedbd9', '1', '常用工具-外部邮件', '1', to_date('22-06-2016 02:15:38', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/email', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('823dd91e1923465b8f5e31db70e8dafa', '1', '代码生成-生成示例-富文本测试', '1', to_date('22-06-2016 02:18:07', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('21bd3e94f02b475e87084106db75e470', '1', '代码生成-生成示例-富文本测试-删除', '1', to_date('22-06-2016 02:18:11', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote/deleteAll', 'GET', 'ids=21ba79fe46ff4e4795e246d5c36e72a3', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7968d0a7817e4459ae8fc4acb69fa5cd', '1', 'ONLINE开发-生成示例-组织结构(树结构)', '1', to_date('22-06-2016 01:22:47', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('25798e711afc48b38e9a488397f8737c', '1', 'ONLINE开发-生成示例-票务代理(一对多）', '1', to_date('22-06-2016 01:22:48', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4d01e2361a304a9d934dd8b6ef9940ea', '1', '系统监控-系统配置', '1', to_date('22-06-2016 01:23:03', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/systemConfig', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('3059606225944353b39999d3bf14cf5e', '1', 'ONLINE开发-表单配置-生成代码', '1', to_date('22-06-2016 01:46:42', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=af61d61368db491cac85ba35e86edd6c', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('dcae8501ed084b64b873abfdbf0b8c26', '1', '系统登录', '1', to_date('22-06-2016 01:46:54', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('c30f30b66c044a70b3b2a29b95c4dbaf', '1', '系统登录', '1', to_date('22-06-2016 01:20:51', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ff657632d5424095989fd1bb2b61e7b3', '1', '系统登录', '1', to_date('22-06-2016 01:21:52', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('54fe301ac0454eddac6590efcb4ccc57', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 01:21:57', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('acaa2c769ced432fb2c132bdf75f0fe5', '1', 'ONLINE开发-生成示例-请假表单(单表）', '1', to_date('22-06-2016 01:22:00', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('96490fb81b4c48f2a8dffd08b1e56211', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 01:59:57', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2fa88590235944f583ec2b66da389517', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 02:00:00', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a5039853cc4d4e89899d23de7d73b30f', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 02:00:40', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4a9713569fc84253bba86f6ffc173718', '1', '系统登录', '1', to_date('22-06-2016 02:02:53', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ea8ea8ffc65a47db96651e46c9738d74', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:03:44', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('494c1b9c46d844a59557f7599286a940', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:05:03', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ec7bc60475ab43b0af2c161fdf1b7348', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:05:33', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('92818c8bc7b544e9b75f6c5a01374364', '1', '代码生成-表单配置-生成代码', '1', to_date('22-06-2016 02:07:40', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=4572e595aff6450fa9583a9302a8f2f6', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('6cc82b45d8c84b87a47da238c729ebaf', '1', '代码生成-表单配置-生成代码', '1', to_date('22-06-2016 02:08:44', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('9fc66410bfb54d91950d4bf4d002b11f', '1', '代码生成-表单配置-生成代码', '1', to_date('22-06-2016 02:09:36', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=84558c0de96b40dfb4ac94db4b0ff79a', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a10ca204ac034a7ca2990a13b9dc4df9', '1', '统计报表-综合报表2', '1', to_date('22-06-2016 02:10:02', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/chinaWeatherDataBean', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ccef8a8f650d4b31a340a3e89e72ee66', '1', '统计报表-班级', '1', to_date('22-06-2016 02:10:04', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pieClass', 'GET', null, null);
commit;
prompt 600 records committed...
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('43f8136ba8f34d008d9e45c85ec09b19', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:10:11', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('76d709869f7446febba78f95e7865b25', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 02:10:30', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('42efd28d4b794ed7a52f35a30389aa5c', '1', '统计报表-饼图', '1', to_date('22-06-2016 02:10:43', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pie', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7c5f6345d60845c8a0165a5a3accb1c8', '1', '统计报表-玫瑰图', '1', to_date('22-06-2016 02:10:44', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/radar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('0080ef68cae6487e95d211ef3233156e', '1', '统计报表-综合报表1', '1', to_date('22-06-2016 02:10:45', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/pieClass', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('219c9773ee8a40058aa58c594c039b07', '1', '统计报表-综合报表2', '1', to_date('22-06-2016 02:10:48', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/chinaWeatherDataBean', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e6f1d42bdff248288fae71a43209fc0f', '1', '代码生成-表单配置', '1', to_date('22-06-2016 02:11:41', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4ab7e0d24755472fa65fba39a0edac6b', '1', '代码生成-生成示例-组织结构(树结构)', '1', to_date('22-06-2016 02:12:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('3e7fa04eb8ca4903a8959270eb465456', '1', '代码生成-生成示例-商品', '1', to_date('22-06-2016 02:12:25', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('488cb4125f3b4c439d71c1f1489b5ed4', '1', '代码生成-生成示例-富文本测试', '1', to_date('22-06-2016 02:12:26', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('37338f9cc0af4ae5bd2ac70eb9d725c2', '1', '统计报表-双数值轴折线图', '1', to_date('22-06-2016 02:12:33', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/echarts/linedoublenum', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('98e05b42bee74257aae0fb6f5d95a177', '1', 'ONLINE开发-生成示例-请假表单(单表）', '1', to_date('22-06-2016 01:20:58', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('62ab6031a439441ca3d6c7cb44f3fe82', '1', '系统登录', '1', to_date('22-06-2016 01:29:17', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('6260ddabcd554e9688febbd2f9cc6238', '1', 'ONLINE开发-生成示例-票务代理(一对多）', '1', to_date('22-06-2016 01:29:20', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('f7a96e0d15b7433da09d1b1e41d5875b', '1', 'ONLINE开发-生成示例-票务代理(一对多）', '1', to_date('22-06-2016 01:30:25', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('af636d086c3b40878ac64ec94ae95dd2', '1', '系统设置-菜单管理', '1', to_date('22-06-2016 01:30:49', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('fd6c22bbead74832b4b1a9a01e141061', '1', 'ONLINE开发-表单配置', '1', to_date('22-06-2016 01:30:57', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('99cfdc6e91d5467fb7b95da4354a1836', '1', 'ONLINE开发-表单配置-导入', '1', to_date('22-06-2016 01:31:05', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/importTableFromDB', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('c009d776662747999f73ac1b80d928a5', '1', 'ONLINE开发-表单配置-同步数据库', '1', to_date('22-06-2016 01:33:34', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=e87f420bb47d4937bdfa83fc664a11cd', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('33055b08f3f145adb50d97afd4905ea7', '1', 'ONLINE开发-生成示例-富文本测试', '1', to_date('22-06-2016 01:38:33', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2f54e54147e147ca91cb10b7d6c8fffa', '1', 'ONLINE开发-生成示例-商品', '1', to_date('22-06-2016 01:46:58', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7188057eed3b45f7bad6690d90d3edf1', '1', 'ONLINE开发-生成示例-富文本测试', '1', to_date('22-06-2016 01:46:59', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b1746ea543d64779bda6c63ea81aeaa2', '1', '系统设置-菜单管理', '1', to_date('06-10-2016 18:34:04', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b196155e6b3a4c12950010ea076a3448', '1', '系统设置-菜单管理', '1', to_date('06-10-2016 18:35:04', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('53cbedec4fbd4673aa2d2e4e28af012a', '1', '系统设置-菜单管理', '1', to_date('06-10-2016 18:35:58', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('d86aa2e65b3c44f9b239311a17677978', '1', '我的面板-我的群组', '1', to_date('06-10-2016 18:36:15', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/layGroup', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a25775b5293b4556bc75f12e750699ec', '1', '系统登录', '1', to_date('06-10-2016 18:41:48', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('75c01f0a88174ca8b9f5ecb140909fb7', '1', '我的面板-我的群组', '1', to_date('06-10-2016 18:41:55', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/layGroup', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('24454da1369a4c8f89438e5fa941fb8f', '1', '代码生成-生成示例-商品', '1', to_date('06-10-2016 18:44:09', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4b86e503ff6d4ddf96a99a6669a6b18c', '1', '我的面板-我的群组', '1', to_date('06-10-2016 18:44:12', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/layGroup', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2af1d8bec0d74e8ca4efc5cd5615ee8a', '1', '我的面板-我的好友', '1', to_date('06-10-2016 18:44:13', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/contact/myFriends', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('9aeff7cd4fec48faac3c0a9d8ff62fb9', '1', '系统设置-用户管理', '1', to_date('06-10-2016 18:34:02', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/user/index', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('c1b0ab5d004a4cd1bad8e249c309b0fb', '1', '系统设置-菜单管理', '1', to_date('06-10-2016 18:35:42', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b2cb5fa2299b49b08c89b55518193631', '1', '系统设置-用户管理', '1', to_date('06-10-2016 18:44:45', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/user/index', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('9729a02378714084ba3d573dbacf1c23', '1', '系统设置-机构管理', '1', to_date('06-10-2016 18:44:50', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/office/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('bbb9304b782542709d80a3d6dee48061', '1', '系统监控-系统监控管理', '1', to_date('06-10-2016 18:44:58', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/monitor/info', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('13d6ed10a2944f21bbadaf3f2d178b16', '1', '代码生成-表单配置-导入', '1', to_date('06-10-2016 18:46:09', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/importTableFromDB', 'POST', 'id=&name=test_validation', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('eebebd98f1e74d3db525d56ab37f3ab5', '1', '代码生成-表单配置-生成代码', '1', to_date('06-10-2016 18:46:17', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=5fe33bf16844427d9fe61f6f2ef16859', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('734f739f0ff948fc876a7ecde634e792', '1', '代码生成-表单配置-生成代码', '1', to_date('06-10-2016 18:47:47', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=5fe33bf16844427d9fe61f6f2ef16859', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2070395bab2f4b2492419bfbf10299b7', '1', '代码生成-表单配置-同步数据库', '1', to_date('06-10-2016 18:33:04', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/synchDb', 'GET', 'id=e87f420bb47d4937bdfa83fc664a11cd', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4f319665934541e4bbbb6cfaf67f83a7', '1', '代码生成-生成示例-富文本测试', '1', to_date('06-10-2016 18:33:11', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('6bca86809c704bf18c28c819d4cdd4c5', '1', '代码生成-生成示例-商品', '1', to_date('06-10-2016 18:33:54', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('afe888361eb742f2a697b113cb2cd10e', '1', '系统登录', '1', to_date('06-10-2016 18:44:00', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('19512d50dc364b759b9e0f6256dface5', '1', '我的面板-通讯录', '1', to_date('06-10-2016 18:44:41', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/contact/index', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7dd173967a8c4eea906457fc6e98b65d', '1', '在线办公-我的通告', '1', to_date('06-10-2016 18:44:43', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/oa/oaNotify/self', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('1154c58af9a24b4e9b324fa8576bf2c5', '1', '在线办公-通告管理', '1', to_date('06-10-2016 18:44:44', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/oa/oaNotify', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('f6ea384bab4b45d2862b6d4be8aef1c8', '1', '系统设置-菜单管理', '1', to_date('06-10-2016 18:44:47', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/menu/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('d2426fa99f50493580e2d167a25cfb23', '1', '系统设置-角色管理', '1', to_date('06-10-2016 18:44:51', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/role/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('30e3a29d06094185ade2cedade5cc4ad', '1', '系统设置-区域管理', '1', to_date('06-10-2016 18:44:52', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/area/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4d241cb3a19e47b79d975e8f30c847de', '1', '系统设置-字典管理', '1', to_date('06-10-2016 18:44:53', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/dict/', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('21345697af9a49c2b5d4c76ef2811b6b', '1', '系统监控-日志查询', '1', to_date('06-10-2016 18:44:56', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/log', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('d667a13e2c1d45368ee0cba71870313f', '1', '系统监控-系统配置', '1', to_date('06-10-2016 18:44:59', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/sys/systemConfig', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('eafef20068db48dcafcc32d28bded5f7', '1', '常用工具-外部邮件', '1', to_date('06-10-2016 18:45:01', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/tools/email', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('4c8d4c7dbbdd4d62a7e071fe3bad3521', '1', '代码生成-表单配置', '1', to_date('06-10-2016 18:45:46', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('ce2741bdebc94fada649d6c74dc93545', '1', '代码生成-表单配置-导入', '1', to_date('06-10-2016 18:45:49', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/importTableFromDB', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('809ae8f016f1415c80691431b5acfebb', '1', '代码生成-表单配置-生成代码', '1', to_date('06-10-2016 18:46:33', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable/genCodeForm', 'GET', 'genTable.id=5fe33bf16844427d9fe61f6f2ef16859', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7c740c7835f343cd9622b09f1095509f', '1', '代码生成-生成示例-富文本测试', '1', to_date('06-10-2016 18:48:23', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('73c5041d03064e739624186103dfa64d', '1', '代码生成-生成示例-测试校验功能', '1', to_date('06-10-2016 18:48:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/validation/testValidation', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('441cafcb35244bb9a673beaef598c26d', '1', '系统登录', '1', to_date('06-10-2016 18:48:28', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2b5bcb5d27d947c09c568e5e3180636e', '1', '代码生成-生成示例-测试校验功能', '1', to_date('06-10-2016 18:48:32', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/validation/testValidation', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('30e895d1322b4c368360df00094f1911', '1', '代码生成-生成示例-富文本测试', '1', to_date('06-10-2016 18:48:59', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('baf5f926f50f4350a48c02ba7e212f26', '1', '代码生成-生成示例-请假表单(单表）', '1', to_date('06-10-2016 18:49:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('f404cbf9ff274ecab4e1d8d83d1b1e54', '1', '代码生成-生成示例-商品', '1', to_date('06-10-2016 18:49:26', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('928d37c2610442bcab24b64432cd1c99', '1', '代码生成-生成示例-商品类型', '1', to_date('06-10-2016 18:49:27', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/category', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('07c476d572d54e448cc871abc5c9e9ac', '1', '代码生成-生成示例-请假表单(单表）', '1', to_date('06-10-2016 18:49:33', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('344a7418890e4952b1803feb00e6bf99', '1', '代码生成-生成示例-组织结构(树结构)', '1', to_date('06-10-2016 18:49:35', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('65a0969b35ee4876b9bdd651e3dce640', '1', '代码生成-生成示例-票务代理(一对多）', '1', to_date('06-10-2016 18:49:36', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('89006f5c6c634c7e8acef6719cac2eaf', '1', '代码生成-表单配置', '1', to_date('06-10-2016 18:49:44', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('850a989fac494c388192e5c2117e6cc2', '1', '代码生成-表单配置', '1', to_date('06-10-2016 18:50:16', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('b2c7deafb3a24b2588290e5fd0b415ec', '1', '代码生成-生成示例-富文本测试', '1', to_date('06-10-2016 18:50:18', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/note/testNote', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('d28232987dc34355a1a8f4a153f7b2e9', '1', '代码生成-生成示例-测试校验功能', '1', to_date('06-10-2016 18:50:19', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/validation/testValidation', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('a957eff5d8ec4367acc7992971f799de', '1', '代码生成-生成示例-商品', '1', to_date('06-10-2016 18:50:19', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/goods', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('6ca0745cc20e4f218f07c0405286177e', '1', '代码生成-生成示例-商品类型', '1', to_date('06-10-2016 18:50:20', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/grid/category', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('58ebc51971c84c1596b51e427ac46f2f', '1', '代码生成-生成示例-请假表单(单表）', '1', to_date('06-10-2016 18:50:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e7ed601235834492b6dda8dcfea5c4c1', '1', '代码生成-生成示例-组织结构(树结构)', '1', to_date('06-10-2016 18:50:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('7aa9389bb9e54b7996e39eeacb61ed92', '1', '代码生成-生成示例-票务代理(一对多）', '1', to_date('06-10-2016 18:50:22', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('2d51eb821b704e219fbae2d90fb4aeb9', '1', '系统登录', '1', to_date('06-10-2016 19:14:21', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a', 'GET', 'login=', null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('de27a794672a48d092045a2d44751e63', '1', '代码生成-生成示例-请假表单(单表）', '1', to_date('06-10-2016 19:14:29', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/one/formLeave', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('107a7bb35ee34b05930a98a658403216', '1', '我的面板-我的好友', '1', to_date('06-10-2016 18:36:14', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/contact/myFriends', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('8e1f643dce354fcd8aec5e6ef99b1e71', '1', '我的面板-我的日程', '1', to_date('06-10-2016 18:36:43', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/iim/myCalendar', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('11d4a5c3dd1a4fd9b1581800b2d25eb8', '1', '代码生成-表单配置', '1', to_date('06-10-2016 19:14:24', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/gen/genTable', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('e23338ebe9914f899da4e81dc4c50390', '1', '代码生成-生成示例-票务代理(一对多）', '1', to_date('06-10-2016 19:14:26', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/onetomany/testDataMain', 'GET', null, null);
insert into SYS_LOG (ID, TYPE, TITLE, CREATE_BY, CREATE_DATE, REMOTE_ADDR, USER_AGENT, REQUEST_URI, METHOD, PARAMS, EXCEPTION)
values ('651baf026409425e9a3f5366823c901a', '1', '代码生成-生成示例-组织结构(树结构)', '1', to_date('06-10-2016 19:14:28', 'dd-mm-yyyy hh24:mi:ss'), '0:0:0:0:0:0:0:1', 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36', '/jeeplus/a/test/tree/testTree', 'GET', null, null);
commit;
...
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('4ada936b3f954989ad7d378700b15dbe', '2be2bf913b3740a58aeecabe6f760dbf', '0,1,2be2bf913b3740a58aeecabe6f760dbf,', '双数值轴折线图', 90, '/echarts/linedoublenum', null, null, '1', null, '1', to_date('22-06-2016 02:06:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:06:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('d8d071f47dc44edd99247a50bf124e94', '2be2bf913b3740a58aeecabe6f760dbf', '0,1,2be2bf913b3740a58aeecabe6f760dbf,', '饼图', 120, '/echarts/pie', null, null, '1', null, '1', to_date('22-06-2016 02:06:34', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:06:34', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('76611514ab7949fab2055b49f917a5ce', '2be2bf913b3740a58aeecabe6f760dbf', '0,1,2be2bf913b3740a58aeecabe6f760dbf,', '玫瑰图', 150, '/echarts/radar', null, null, '1', null, '1', to_date('22-06-2016 02:06:50', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:06:50', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('2be2bf913b3740a58aeecabe6f760dbf', '1', '0,1,', '统计报表', 10, null, null, 'fa-line-chart', '1', null, '1', to_date('22-06-2016 02:05:03', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:05:03', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('c98afb111e8745dc98db9874ca48996f', '2be2bf913b3740a58aeecabe6f760dbf', '0,1,2be2bf913b3740a58aeecabe6f760dbf,', '柱状图', 30, '/echarts/bar', null, null, '1', null, '1', to_date('22-06-2016 02:05:32', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:05:32', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('b25272dc3c024061926750d3c8a688a2', '2be2bf913b3740a58aeecabe6f760dbf', '0,1,2be2bf913b3740a58aeecabe6f760dbf,', '折线图', 60, '/echarts/line', null, null, '1', null, '1', to_date('22-06-2016 02:05:52', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:05:52', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('be64b56bb0fc4e9b87ef41b3b3176488', '2be2bf913b3740a58aeecabe6f760dbf', '0,1,2be2bf913b3740a58aeecabe6f760dbf,', '综合报表1', 15110, '/echarts/pieClass', null, null, '1', 'echarts:pieClass:list', '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:10:30', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('98b3e1422abf443dbd38fd3aee182a3d', 'be64b56bb0fc4e9b87ef41b3b3176488', '0,1,2be2bf913b3740a58aeecabe6f760dbf,be64b56bb0fc4e9b87ef41b3b3176488,', '增加', 30, null, null, null, '0', 'echarts:pieClass:add', '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('255b680258cf4ab2a92e0255b83d1026', 'be64b56bb0fc4e9b87ef41b3b3176488', '0,1,2be2bf913b3740a58aeecabe6f760dbf,be64b56bb0fc4e9b87ef41b3b3176488,', '删除', 60, null, null, null, '0', 'echarts:pieClass:del', '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('85834a231a2e44369a0f833a7477ff1c', 'be64b56bb0fc4e9b87ef41b3b3176488', '0,1,2be2bf913b3740a58aeecabe6f760dbf,be64b56bb0fc4e9b87ef41b3b3176488,', '编辑', 90, null, null, null, '0', 'echarts:pieClass:edit', '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('d9a37b840f5e44e593c146062221f7df', 'be64b56bb0fc4e9b87ef41b3b3176488', '0,1,2be2bf913b3740a58aeecabe6f760dbf,be64b56bb0fc4e9b87ef41b3b3176488,', '查看', 120, null, null, null, '0', 'echarts:pieClass:view', '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('7035459edfe048ffa457720234fe6c9c', 'be64b56bb0fc4e9b87ef41b3b3176488', '0,1,2be2bf913b3740a58aeecabe6f760dbf,be64b56bb0fc4e9b87ef41b3b3176488,', '导入', 150, null, null, null, '0', 'echarts:pieClass:import', '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('0417b8c5ef6d494390b221785f89af6c', 'be64b56bb0fc4e9b87ef41b3b3176488', '0,1,2be2bf913b3740a58aeecabe6f760dbf,be64b56bb0fc4e9b87ef41b3b3176488,', '导出', 180, null, null, null, '0', 'echarts:pieClass:export', '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:08:24', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('4761fd85fd74401a8e0dcf3a028f7726', '2be2bf913b3740a58aeecabe6f760dbf', '0,1,2be2bf913b3740a58aeecabe6f760dbf,', '综合报表2', 15120, '/echarts/chinaWeatherDataBean', null, null, '1', 'echarts:chinaWeatherDataBean:list', '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('a7f0789dce49491e8d666b549637dd6a', '4761fd85fd74401a8e0dcf3a028f7726', '0,1,2be2bf913b3740a58aeecabe6f760dbf,4761fd85fd74401a8e0dcf3a028f7726,', '增加', 30, null, null, null, '0', 'echarts:chinaWeatherDataBean:add', '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('dede9143d18f4fc48f25990a5503bfca', '4761fd85fd74401a8e0dcf3a028f7726', '0,1,2be2bf913b3740a58aeecabe6f760dbf,4761fd85fd74401a8e0dcf3a028f7726,', '删除', 60, null, null, null, '0', 'echarts:chinaWeatherDataBean:del', '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('5137fc5381504d8d83237dc28f5487b9', '4761fd85fd74401a8e0dcf3a028f7726', '0,1,2be2bf913b3740a58aeecabe6f760dbf,4761fd85fd74401a8e0dcf3a028f7726,', '编辑', 90, null, null, null, '0', 'echarts:chinaWeatherDataBean:edit', '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('740b7670898446c2b427871bf8d661f6', '4761fd85fd74401a8e0dcf3a028f7726', '0,1,2be2bf913b3740a58aeecabe6f760dbf,4761fd85fd74401a8e0dcf3a028f7726,', '查看', 120, null, null, null, '0', 'echarts:chinaWeatherDataBean:view', '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('6b7cd5c0791844c888251c220460fd3d', '4761fd85fd74401a8e0dcf3a028f7726', '0,1,2be2bf913b3740a58aeecabe6f760dbf,4761fd85fd74401a8e0dcf3a028f7726,', '导入', 150, null, null, null, '0', 'echarts:chinaWeatherDataBean:import', '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('89f52c8fafbb451e83b0e1d0b236ba78', '4761fd85fd74401a8e0dcf3a028f7726', '0,1,2be2bf913b3740a58aeecabe6f760dbf,4761fd85fd74401a8e0dcf3a028f7726,', '导出', 180, null, null, null, '0', 'echarts:chinaWeatherDataBean:export', '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:09:49', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('ac5f7caad684406fb1ad53d2874821a7', '27', '0,1,27,', '我的日程', 100, '/iim/myCalendar', null, null, '1', null, '1', to_date('06-10-2016 18:35:02', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:35:02', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('ce3ceecbd9e04a9aa0eb884be359e332', '27', '0,1,27,', '我的群组', 200, '/iim/layGroup', null, null, '1', null, '1', to_date('06-10-2016 18:35:56', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:35:56', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('c2eb9065e12340889d5738e5f7e24c12', '3c92c17886944d0687e73e286cada573', '0,1,79,3c92c17886944d0687e73e286cada573,', '测试校验功能', 15120, '/test/validation/testValidation', null, null, '1', 'test:validation:testValidation:list', '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('fa6802e3a65245b4a958c6204987da3d', 'c2eb9065e12340889d5738e5f7e24c12', '0,1,79,3c92c17886944d0687e73e286cada573,c2eb9065e12340889d5738e5f7e24c12,', '增加', 30, null, null, null, '0', 'test:validation:testValidation:add', '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('b2039dd7f97e4188b1966eda1940446d', 'c2eb9065e12340889d5738e5f7e24c12', '0,1,79,3c92c17886944d0687e73e286cada573,c2eb9065e12340889d5738e5f7e24c12,', '删除', 60, null, null, null, '0', 'test:validation:testValidation:del', '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('be9cb6c2b39a43afac4b5a5174d41514', 'c2eb9065e12340889d5738e5f7e24c12', '0,1,79,3c92c17886944d0687e73e286cada573,c2eb9065e12340889d5738e5f7e24c12,', '编辑', 90, null, null, null, '0', 'test:validation:testValidation:edit', '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('6fff937314a14527b02abc49226ea913', 'c2eb9065e12340889d5738e5f7e24c12', '0,1,79,3c92c17886944d0687e73e286cada573,c2eb9065e12340889d5738e5f7e24c12,', '查看', 120, null, null, null, '0', 'test:validation:testValidation:view', '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('c86cf96cb4714cc499a0e965a1af020e', 'c2eb9065e12340889d5738e5f7e24c12', '0,1,79,3c92c17886944d0687e73e286cada573,c2eb9065e12340889d5738e5f7e24c12,', '导入', 150, null, null, null, '0', 'test:validation:testValidation:import', '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('f4e5a50a68d14345ad39f9c3357d986d', 'c2eb9065e12340889d5738e5f7e24c12', '0,1,79,3c92c17886944d0687e73e286cada573,c2eb9065e12340889d5738e5f7e24c12,', '导出', 180, null, null, null, '0', 'test:validation:testValidation:export', '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:48:18', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('209fab1a225a4a3c81f20476c36cfcd3', '3c92c17886944d0687e73e286cada573', '0,1,79,3c92c17886944d0687e73e286cada573,', '富文本测试', 15120, '/test/note/testNote', null, null, '1', 'test:note:testNote:list', '1', to_date('22-06-2016 01:38:19', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:19', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('bfee6e470eb740dab2443a53850a05b4', '209fab1a225a4a3c81f20476c36cfcd3', '0,1,79,3c92c17886944d0687e73e286cada573,209fab1a225a4a3c81f20476c36cfcd3,', '增加', 30, null, null, null, '0', 'test:note:testNote:add', '1', to_date('22-06-2016 01:38:19', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:19', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('c35f7d3c78d74fae88e21cd29b65a787', '209fab1a225a4a3c81f20476c36cfcd3', '0,1,79,3c92c17886944d0687e73e286cada573,209fab1a225a4a3c81f20476c36cfcd3,', '删除', 60, null, null, null, '0', 'test:note:testNote:del', '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('9a88999f361d4f0a9ac01f1e677b344f', '209fab1a225a4a3c81f20476c36cfcd3', '0,1,79,3c92c17886944d0687e73e286cada573,209fab1a225a4a3c81f20476c36cfcd3,', '编辑', 90, null, null, null, '0', 'test:note:testNote:edit', '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('ebcbd762bcf0485ba883e00dbc17f5d4', '209fab1a225a4a3c81f20476c36cfcd3', '0,1,79,3c92c17886944d0687e73e286cada573,209fab1a225a4a3c81f20476c36cfcd3,', '查看', 120, null, null, null, '0', 'test:note:testNote:view', '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('326d551f4e9f4ef7b16ab881d485e853', '209fab1a225a4a3c81f20476c36cfcd3', '0,1,79,3c92c17886944d0687e73e286cada573,209fab1a225a4a3c81f20476c36cfcd3,', '导入', 150, null, null, null, '0', 'test:note:testNote:import', '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('046be115646d4d31a947009da1db36f1', '209fab1a225a4a3c81f20476c36cfcd3', '0,1,79,3c92c17886944d0687e73e286cada573,209fab1a225a4a3c81f20476c36cfcd3,', '导出', 180, null, null, null, '0', 'test:note:testNote:export', '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:38:20', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('b468ebddf2ee472991201f01636327c5', '3c92c17886944d0687e73e286cada573', '0,1,79,3c92c17886944d0687e73e286cada573,', '商品', 15120, '/test/grid/goods', null, null, '1', 'test:grid:goods:list', '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('75d4f5e33f5d4d3190a0a25cb2b5a706', 'b468ebddf2ee472991201f01636327c5', '0,1,79,3c92c17886944d0687e73e286cada573,b468ebddf2ee472991201f01636327c5,', '增加', 30, null, null, null, '0', 'test:grid:goods:add', '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('1d9487483e2d4fa89695724bb598ed87', 'b468ebddf2ee472991201f01636327c5', '0,1,79,3c92c17886944d0687e73e286cada573,b468ebddf2ee472991201f01636327c5,', '删除', 60, null, null, null, '0', 'test:grid:goods:del', '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('8d690de9471c463a81e7c1b98d3d3a43', 'b468ebddf2ee472991201f01636327c5', '0,1,79,3c92c17886944d0687e73e286cada573,b468ebddf2ee472991201f01636327c5,', '编辑', 90, null, null, null, '0', 'test:grid:goods:edit', '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('ef8f53beb186413a87390d8ba5e1c52f', 'b468ebddf2ee472991201f01636327c5', '0,1,79,3c92c17886944d0687e73e286cada573,b468ebddf2ee472991201f01636327c5,', '查看', 120, null, null, null, '0', 'test:grid:goods:view', '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('acad0184c4594a068df8293375849368', 'b468ebddf2ee472991201f01636327c5', '0,1,79,3c92c17886944d0687e73e286cada573,b468ebddf2ee472991201f01636327c5,', '导入', 150, null, null, null, '0', 'test:grid:goods:import', '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('69a295472cd84d1fa5f5d604c939edf8', 'b468ebddf2ee472991201f01636327c5', '0,1,79,3c92c17886944d0687e73e286cada573,b468ebddf2ee472991201f01636327c5,', '导出', 180, null, null, null, '0', 'test:grid:goods:export', '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:37', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('19c201de4632434ca0931ecc3937f1dc', '3c92c17886944d0687e73e286cada573', '0,1,79,3c92c17886944d0687e73e286cada573,', '商品类型', 15120, '/test/grid/category', null, null, '1', 'test:grid:category:list', '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('985fb30d5dd94191a9107511a9431883', '19c201de4632434ca0931ecc3937f1dc', '0,1,79,3c92c17886944d0687e73e286cada573,19c201de4632434ca0931ecc3937f1dc,', '增加', 30, null, null, null, '0', 'test:grid:category:add', '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('14ffcd842be9487fae8b310e0e71e688', '19c201de4632434ca0931ecc3937f1dc', '0,1,79,3c92c17886944d0687e73e286cada573,19c201de4632434ca0931ecc3937f1dc,', '删除', 60, null, null, null, '0', 'test:grid:category:del', '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('f47cafbf0b724710ac106dafb3a382c1', '19c201de4632434ca0931ecc3937f1dc', '0,1,79,3c92c17886944d0687e73e286cada573,19c201de4632434ca0931ecc3937f1dc,', '编辑', 90, null, null, null, '0', 'test:grid:category:edit', '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('8222e880104e467aba8ee643fbe61160', '19c201de4632434ca0931ecc3937f1dc', '0,1,79,3c92c17886944d0687e73e286cada573,19c201de4632434ca0931ecc3937f1dc,', '查看', 120, null, null, null, '0', 'test:grid:category:view', '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('b6e8d666cd1f4bd58447705300960c6f', '19c201de4632434ca0931ecc3937f1dc', '0,1,79,3c92c17886944d0687e73e286cada573,19c201de4632434ca0931ecc3937f1dc,', '导入', 150, null, null, null, '0', 'test:grid:category:import', '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('fb025c7282234972ada9b7cd49f84712', '19c201de4632434ca0931ecc3937f1dc', '0,1,79,3c92c17886944d0687e73e286cada573,19c201de4632434ca0931ecc3937f1dc,', '导出', 180, null, null, null, '0', 'test:grid:category:export', '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:46:51', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('79', '1', '0,1,', '代码生成', 20, null, null, 'fa-codepen', '1', null, '1', to_date('19-02-2016 18:01:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:03:43', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('9fdf5971a9e64fac8bbffec2825a5f97', '27', '0,1,27,', '我的好友', 180, '/iim/contact/myFriends', null, null, '1', null, '1', to_date('19-02-2016 18:01:43', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:35:40', 'dd-mm-yyyy hh24:mi:ss'), null, '0');
insert into SYS_MENU (ID, PARENT_ID, PARENT_IDS, NAME, SORT, HREF, TARGET, ICON, IS_SHOW, PERMISSION, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
...
values ('f6679e1c07b94e2f9b66d69b271e1bbe', '1', '5', 'test', '8375ad31c441100804affefac287c5b34f1a41f1e1e544bf0954ae1b', '20160225', 'test', null, null, null, '1', '/BZDX/userfiles/1/images/photo/2016/02/my.jpg', '127.0.0.1', to_date('25-02-2016 22:55:46', 'dd-mm-yyyy hh24:mi:ss'), '1', '1', to_date('25-02-2016 21:49:41', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('14-03-2016 20:42:43', 'dd-mm-yyyy hh24:mi:ss'), '管理员', '0', '/jeeplus/userfiles/f6679e1c07b94e2f9b66d69b271e1bbe/qrcode/f6679e1c07b94e2f9b66d69b271e1bbe.png', null);
insert into SYS_USER (ID, COMPANY_ID, OFFICE_ID, LOGIN_NAME, PASSWORD, NO, NAME, EMAIL, PHONE, MOBILE, USER_TYPE, PHOTO, LOGIN_IP, LOGIN_DATE, LOGIN_FLAG, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, QRCODE, SIGN)
values ('1', '1', '5', 'admin', 'd6a33a2456338a88acec133487d38ccf163abb4575b368b074e327ee', '0001', 'admin', null, null, null, '1', '/BZDX/userfiles/1/images/my.jpg', '0:0:0:0:0:0:0:1', to_date('06-10-2016 19:14:21', 'dd-mm-yyyy hh24:mi:ss'), '1', '1', null, '1', to_date('14-03-2016 20:43:00', 'dd-mm-yyyy hh24:mi:ss'), '系统管理员', '0', '/jeeplus/userfiles/1/qrcode/1.png', null);
commit;
prompt 2 records loaded
...
prompt Loading TESTNOTE...
insert into TESTNOTE (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, TITLE, CONTENTS)
values ('a610de5249d84ca18d81739e923732ff', '1', to_date('06-10-2016 18:33:15', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:33:15', 'dd-mm-yyyy hh24:mi:ss'), null, '0', '11', null);
insert into TESTNOTE (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, TITLE, CONTENTS)
values ('80f0eadc691c4718925ecd73af21a145', '1', to_date('06-10-2016 18:49:07', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:49:07', 'dd-mm-yyyy hh24:mi:ss'), null, '0', 'aaa', null);
commit;
prompt 2 records loaded
...
insert into TEST_DATA_MAIN (ID, USER_ID, OFFICE_ID, AREA_ID, NAME, SEX, IN_DATE, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('aaea0d9f6a6b4d86a6d888ffaa0f050c', 'f6679e1c07b94e2f9b66d69b271e1bbe', '5', '17e8e72326574a0ea94b15d6eeddbb6d', 'test', '1', to_date('14-06-2016', 'dd-mm-yyyy'), '1', to_date('22-06-2016 01:29:41', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 01:29:41', 'dd-mm-yyyy hh24:mi:ss'), 'test', '0');
commit;
prompt 1 records loaded
prompt Loading TEST_INTERFACE...
insert into TEST_INTERFACE (ID, TYPE, URL, BODY, SUCCESSMSG, ERRORMSG, DEL_FLAG, NAME, REMARKS)
...
prompt Loading TEST_LINE_WEATHER_MAIN_CITY...
...
values ('666705be814f406e80042346c093dbd6', '1', to_date('22-06-2016 02:11:02', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:11:02', 'dd-mm-yyyy hh24:mi:ss'), null, '0', to_date('15-06-2016', 'dd-mm-yyyy'), 36, 12, 12, 121, 21, 21, 212, 21);
insert into TEST_LINE_WEATHER_MAIN_CITY (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG, DATESTR, BEIJING_MAXTEMP, BEIJING_MINTEMP, CHANGCHUN_MAXTEMP, CHANGCHUN_MINTEMP, SHENYANG_MAXTEMP, SHENYANG_MINTEMP, HAERBIN_MAXTEMP, HAERBIN_MINTEMP)
values ('4b18a6e7b43543ad92418dd4611b4059', '1', to_date('22-06-2016 02:11:23', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:11:23', 'dd-mm-yyyy hh24:mi:ss'), null, '0', to_date('14-06-2016', 'dd-mm-yyyy'), 44, 33, 232, 12, 212, 12, 3, 1);
commit;
prompt 2 records loaded
prompt Loading TEST_PIE_CLASS...
insert into TEST_PIE_CLASS (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, DEL_FLAG, CLASS_NAME, NUM, REMARKS)
values ('86a9bbee9e4449f3b56f0cab41bccfd4', '1', to_date('22-06-2016 02:11:34', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('22-06-2016 02:11:34', 'dd-mm-yyyy hh24:mi:ss'), '0', '1', '1', '1');
commit;
prompt 1 records loaded
...
commit;
prompt 1 records loaded
prompt Loading TEST_VALIDATION...
insert into TEST_VALIDATION (ID, NUM2, STR, EMAIL, URL, NEW_DATE, REMARKS, NUM)
values ('67fee299a14343e5915f710e1bcebf60', 23, '33333', null, null, null, null, null);
commit;
prompt 1 records loaded
prompt Loading T_GROUP...
insert into T_GROUP (ID, GROUPNAME, AVATAR, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, REMARKS, DEL_FLAG)
values ('7e1c137c90f3437fbd4c85bd9a6c1de7', 'te', null, '1', to_date('06-10-2016 18:44:25', 'dd-mm-yyyy hh24:mi:ss'), '1', to_date('06-10-2016 18:44:25', 'dd-mm-yyyy hh24:mi:ss'), 'te', '0');
commit;
prompt 1 records loaded
...
prompt Enabling triggers for GROUP_USER...
alter table GROUP_USER enable all triggers;
...
prompt Enabling triggers for TESTNOTE...
alter table TESTNOTE enable all triggers;
...
prompt Enabling triggers for TEST_LINE_WEATHER_MAIN_CITY...
alter table TEST_LINE_WEATHER_MAIN_CITY enable all triggers;
prompt Enabling triggers for TEST_PIE_CLASS...
alter table TEST_PIE_CLASS enable all triggers;
prompt Enabling triggers for TEST_TREE...
alter table TEST_TREE enable all triggers;
prompt Enabling triggers for TEST_VALIDATION...
alter table TEST_VALIDATION enable all triggers;
prompt Enabling triggers for T_GROUP...
alter table T_GROUP enable all triggers;
set feedback on
set define on
prompt Done.
