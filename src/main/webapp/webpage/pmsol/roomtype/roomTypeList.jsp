...
<div class="wrapper wrapper-content">
    <div class="ibox">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form:form id="searchForm" modelAttribute="roomType" action="${ctx}/roomtype/roomType/"
                ...
                <div class="col-sm-12">
                    <div class="pull-left">
                        ...
                        <shiro:hasPermission name="roomtype:roomType:edit">
                            <table:editRow url="${ctx}/roomtype/roomType/form" title="房型"
                                           id="contentTable"></table:editRow><!-- 编辑按钮 -->
                        </shiro:hasPermission>
                        <shiro:hasPermission name="roomtype:roomType:del">
                            <table:delRow url="${ctx}/roomtype/roomType/deleteAll"
                    ...
                    <tr>
                        ...
                        <td>
                            <shiro:hasPermission name="roomtype:roomType:view">
                                <a href="#"
                                   onclick="openDialogView('查看房型', '${ctx}/roomtype/roomType/form?id=${roomType.id}','800px', '500px')"
                                   class="btn btn-info btn-xs"><i class="fa fa-search-plus"></i> 查看</a>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="roomtype:roomType:edit">
                                <a href="#"
                                   onclick="openDialog('修改房型', '${ctx}/roomtype/roomType/form?id=${roomType.id}','800px', '500px')"
                                   class="btn btn-success btn-xs"><i class="fa fa-edit"></i> 修改</a>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="roomtype:roomType:del">
                                <a href="${ctx}/roomtype/roomType/delete?id=${roomType.id}"
                                   onclick="return confirmx('确认要删除该房型吗？', this.href)" class="btn btn-danger btn-xs"><i
