		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      <tr>
		         ...
		         <td  class="width-15" class="active"><label class="pull-right"><font color="red">*</font>岗位名称:</label></td>
		      ...
		      <tr>
		         ...
		         <td  class="width-15" class="active"><label class="pull-right">岗位类型:</label></td>
		         <td class="width-35"><%--
					...
					<span class="help-inline" title="activiti有3种预定义的组类型：security-role、assignment、user 如果使用Activiti Explorer，需要security-role才能看到manage页签，需要assignment才能claim任务">
						工作流组用户组类型（任务分配：assignment、管理岗位：security-role、普通岗位：user）</span></td>
		      </tr>
		      <tr>
