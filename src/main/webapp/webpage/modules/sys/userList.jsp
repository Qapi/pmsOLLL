...
<body>
	...
	<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/list" method="post" class="form-inline">
		...
		<div class="form-group">
			<span>姓&nbsp;&nbsp;&nbsp;名：</span>
				<form:input path="name" htmlEscape="false" maxlength="20" class=" form-control input-sm"/>
			<span>身份证号：</span>
			<form:input path="idNum" htmlEscape="false" maxlength="18" class=" form-control input-sm"/>
			<span>手机号：</span>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th class="sort-column gender">身份证号</th>
